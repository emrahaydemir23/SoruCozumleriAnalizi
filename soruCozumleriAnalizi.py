...
try:
    ...
    df7.loc[len(df7.index)] = ['En Az Net Oranı Olan Kitap', df3.sort_values(by=['Net Oranı'],ascending=True).iloc[-1]["Kitap Adı"]]
    ...
    df7.loc[len(df7.index)] = ['En Az Net Oranı Olan Ders', df4.sort_values(by=['Net Oranı'],ascending=True).iloc[-1]["Ders Adı"]]
